          ...
          <div className="flex items-center gap-4">
            <div className="relative hidden md:block">
              ...
              <input 
                ...
                className="pl-10 pr-4 py-2 text-sm bg-white text-brand-950 placeholder:text-brand-400 border-none rounded-full focus:ring-2 focus:ring-brand-300 w-80 shadow-sm transition-all"
              />
            </div>
