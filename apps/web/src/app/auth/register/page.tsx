...
export default function RegisterPage() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl shadow-lg shadow-red-500/10 p-8 border border-slate-200 dark:border-zinc-800">
        ...
        <form className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input 
                type="text" 
                className="w-full bg-slate-50 dark:bg-zinc-800 border border-transparent focus:bg-white dark:focus:bg-zinc-900 focus:ring-2 focus:ring-[#D00000] rounded-xl px-4 py-3 transition-all"
              />
            </div>
            <div>
